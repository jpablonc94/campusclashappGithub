...
if(!isset($_SESSION["session_username"])) { 
    ...
    include 'comprobar_modificar_premio.php';
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-12" style="margin:0px;">                        
                        <form name="cambiar" action="modificar_premio.php" method="post">
                            <h4 style="margin: 0px;">Cambiar asignatura:</h4>
                ...
                <div class="row">
                    <div class="col-lg-12" style="margin:0px;">                        
                        <form name="cambiar" action="modificar_premio.php" method="post">
                            <h4 style="margin: 0px;">Cambiar nombre del premio:</h4>
                ...
                <div class="row">
                    <div class="col-lg-12" style="margin:0px;">                        
                        <h4 style="margin: 0px;">Eliminar Premio de la base de datos</h4>
                        <br>
                        <a href="eliminar_producto.php"><button>Eliminar Premio</button></a>
                   </div>
                </div>           
            </div>
            <!-- /.container-fluid -->
